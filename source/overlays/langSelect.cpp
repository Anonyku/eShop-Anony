...
static const std::vector<std::string> languages = { "Dansk", "Deutsch", "English", "Español", "Français", "Italiano", "Lietuvių", "Magyar", "Polski", "Português", "Русский", "日本語" };
static const std::string langsTemp[] = { "da", "de", "en", "es", "fr", "it", "lt", "hu", "pl", "pt", "ru", "jp"};
